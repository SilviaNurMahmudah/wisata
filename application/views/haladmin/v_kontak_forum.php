...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url();?>https://objectstorage.ap-melbourne-1.oraclecloud.com/p/Zgbj48rtjoiRC1X2mGJ7Pe-sl4Czq_BaAtsOpel-z_TOGKl21977C9GTi4UT92vG/n/ax5kbrxjysuz/b/Uminur/o/styleutama.css" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li>
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>index.php/">Destinasi</a>
                    </li>
                    <li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-body -->
                   <?php echo form_open_multipart('/tambah')?>
